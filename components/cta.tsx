      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            <div>
              <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-emerald-500 to-emerald-200 pb-3">The gaming movement</div>
            </div>
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-4">Take control of your compute</h2>
            <p className="text-lg text-slate-400 mb-8">Billions of dollars are being spent and consumed on datacenters. You own idles that can power the next gaming revolution. Unlock it now.</p>
            {/* <div>
