          ...
          <div className="sm:col-span-12 lg:col-span-4 order-1 lg:order-none">
            <div className="h-full flex flex-col sm:flex-row lg:flex-col justify-between">
              <div className="mb-4 sm:mb-0">
                ...
                <div className="text-sm text-slate-300">© Shaga.xyz <span className="text-slate-500">-</span> All rights reserved.</div>
              </div>
              {/* Social links */}
              <ul className="flex">
                <li>
                  <a className="flex justify-center items-center text-emerald-500 hover:text-emerald-400 transition duration-150 ease-in-out" href="https://twitter.com/Web3Shaga" aria-label="Twitter">
                ...
                <li className="ml-2">
                  <a className="flex justify-center items-center text-emerald-500 hover:text-emerald-400 transition duration-150 ease-in-out" href="#0" aria-label="Dev.to">
