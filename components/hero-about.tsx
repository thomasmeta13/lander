    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      <div className="pt-32 pb-10 md:pt-40">
        ...
        <div className="text-center">
          ...
          <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-6">Turning security into innovation</h1>
          {/* Rings illustration */}
