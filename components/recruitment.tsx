    ...
    <section className="relative">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t [border-image:linear-gradient(to_right,transparent,theme(colors.slate.800),transparent)1]">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-4">Join a team of makers</h2>
      ...
      <div className="relative px-4 sm:px-6">
        ...
        <div className="max-w-3xl mx-auto py-12 md:py-20">
          <h3 className="h3 inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8 md:pb-16">Open positions</h3>
