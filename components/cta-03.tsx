      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="relative px-8 py-12 md:py-20 rounded-[3rem] overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-4">Take control of your business</h2>
            ...
            <form className="inline-flex max-w-sm w-full">
              <div className="w-full flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-none">
                <input type="email" className="form-input py-1.5 w-full mb-3 sm:mb-0 sm:mr-2 rounded-full bg-zinc-900/30 border-slate-700" placeholder="Your email" aria-label="Your email" />
