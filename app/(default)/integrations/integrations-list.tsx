        ...
        <div className="pb-12 md:pb-20">
          ...
          <div>
            ...
            <div className="mt-12 md:mt-16">
              <h3 id="engineering" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8">Engineering</h3>
            ...
            {/* Section #2 */}
            <div className="mt-12 md:mt-16">
              <h3 id="nocode" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8">No-code</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Section #3 */}
            <div className="mt-12 md:mt-16">
              <h3 id="collaboration" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8">Collaboration</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {/* Section #4 */}
            <div className="mt-12 md:mt-16">
              <h3 id="productivity" className="scroll-mt-8 text-2xl font-bold inline-flex bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8">Productivity</h3>
              <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
...
export function IntegrationCard({ item, index }: CardProps) {
  return (
    <div key={index} className="bg-gradient-to-tr from-zinc-800 to-slate-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
      <div className="flex flex-col p-5 h-full">
        <div className="flex items-center space-x-3 mb-3">
          ...
          <Link className="font-semibold bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 group-hover:before:absolute group-hover:before:inset-0" href={item.link}>{item.name}</Link>
        </div>
        <div className="grow">
