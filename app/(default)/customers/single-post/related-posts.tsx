...
export default function RelatedPosts() {
  ...
  return (
    <aside>
      <h2 className="inline-flex font-bold text-lg bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-8">Related stories</h2>
