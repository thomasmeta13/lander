        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="text-center pb-12 md:pb-20">
              <h1 className="h1 bg-clip-text text-transparent bg-gradient-to-r from-zinc-200/60 via-slate-200 to-slate-200/60 pb-4">What's New</h1>
              <div className="max-w-3xl mx-auto">
                <p className="text-lg text-slate-400">Where we are at for Shaga's development.</p>
              </div>
            </div>
